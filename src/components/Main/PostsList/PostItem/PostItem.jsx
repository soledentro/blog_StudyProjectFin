    ...
    return (
        <div className="p-2 flex-fill bd-highlight mb-3" style={{ width: '18rem' }}>
            ...
            <div className="card-body outline-y">
                ...
                <p className="card-text">{text} <NavLink className="nav-link" to={`/post/${id}`}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
