            ...
            <div className="card d-flex justify-context-center" >
                ...
                <div className="card-body outline-y">
                    ...
                    <div className="d-grid gap-2 d-md-block">
                        <button data-tip data-for="back" onClick={() => { navigate(-1) }} type="button" className="btn btn-outline-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                        </svg></button>
                        <ReactTooltip id="back">
                            <span>Назад</span>
                        </ReactTooltip>
                        <button data-tip data-for="edit" onClick={deleteHandler} type="button" className="btn btn-outline-primary mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
