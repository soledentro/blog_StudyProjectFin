    ...
    return (
        <>
            <motion.div variants={inputVariants} initial="start" animate="end" className="input-group mb-3" width="100">
                <span className="input-group-text" id="addon-wrapping"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
